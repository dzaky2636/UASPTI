...
import step1 from "../assets/howto/1.png";
...
export function Home() {
	...
	return (
		<div className="text-white flex flex-col">
			{/* Bagian 1 */}
			<Navbar />
			<div className="bg-gradient-to-b from-[#CAF0F8] to-[#48CAE4] h-[135rem] lg:h-[140rem]  mt-10">
				...
				<div className="container mx-auto scale-100">
					<div className="mx-2 ">
						...
						<div className="">
							...
							<div className="flex flex-col md:flex-row lg:flex-row gap-0 lg:gap-4">
								<HowTo title="Hello" image={step1} />
								<HowTo title="Hello" image={step1} />
								<HowTo title="Hello" image={step1} />
							</div>
						</div>
			...
			{/* Bagian 2 */}
			<div className="relative top-[10rem] md:top-[-29rem] lg:top-[-15rem]">
